...
export default function Resume(){
  ...
  useEffect(()=>{
    ...
    window.addEventListener('orientationchange', updatePdfHeight);
    return () => { window.removeEventListener('resize', updatePdfHeight); window.removeEventListener('orientationchange', updatePdfHeight); };
  },[]);
