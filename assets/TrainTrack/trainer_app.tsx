...
// ── ROOT ──────────────────────────────────────────────────────────────────────
export default function App(props:any){ const compact = props?.compact ?? false;
  ...
  return (
    <div className={`traintrack-root ${compact? 'traintrack-compact':''}`} style={{fontFamily:"var(--font-sans)",border:"0.5px solid var(--color-border-tertiary)",borderRadius: compact?8:(isMobile?0:12),overflow:"hidden",display:"flex",flexDirection:"column",height:"100%",minHeight: compact?220:600,position:"relative",maxWidth:"100%"}}>
      {workoutSession&&(
